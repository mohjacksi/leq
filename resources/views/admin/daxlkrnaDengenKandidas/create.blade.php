...
@section('content')
    ...
    <div class="card border-primary">
        ...
        <div class="card-body text-info">
            <form method="POST" action="{{ route('admin.daxlkrna-dengen-kandidas.store') }}"
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control select2 {{ $errors->has('westgeh') ? 'is-invalid' : '' }}"
                            name="westgeh_id" id="westgeh_id">
                        ...
                        <select class="form-control select2 {{ $errors->has('jimara_kandidi') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($jimara_kandidis as $id => $entry)
                                <option class="{{ $entry->layene_siyasi_id ?? '' }}" value="{{ $entry->id ?? '' }}"
                                    {{ old('jimara_kandidi_id') == ($entry->id ?? '') ? 'selected' : '' }}>
                                    {{ $entry->nav ?? '' }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select class="form-control {{ $errors->has('layenesiyasi') ? 'is-invalid' : '' }}"
                            ...
                            @foreach ($layenesiyasis as $id => $entry)
                                <option value="{{ $entry->id ?? '' }}"
                                    {{ old('layenesiyasi_id') == ($entry->id ?? '') ? 'selected' : '' }}>
                                    {{ $entry->name ?? '' }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('jimara_dengan') ? 'is-invalid' : '' }}" type="number"
                            name="jimara_dengan" id="jimara_dengan" value="{{ old('jimara_dengan', '0') }}" step="1"
                            required>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control ckeditor {{ $errors->has('extra_1') ? 'is-invalid' : '' }}"
                            name="extra_1" id="extra_1">{!! old('extra_1') !!}</textarea>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input class="form-control {{ $errors->has('extra_2') ? 'is-invalid' : '' }}" type="text"
                            name="extra_2" id="extra_2" value="{{ old('extra_2', '') }}">
