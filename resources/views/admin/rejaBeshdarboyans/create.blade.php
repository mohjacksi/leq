    ...
    <div class="card-body text-info">
        <form method="POST" action="{{ route("admin.reja-beshdarboyans.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('jimara_beshdarboyan') ? 'is-invalid' : '' }}" type="number" name="jimara_beshdarboyan" id="jimara_beshdarboyan" value="{{ old('jimara_beshdarboyan', '0') }}" step="1" required>
