...
<div class="card border-primary">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.westgeh.title_singular') }}
    </div>

    <div class="card-body text-info">
        <form method="POST" action="{{ route("admin.westgehs.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('westgeh_code') ? 'is-invalid' : '' }}" type="text" name="westgeh_code" id="westgeh_code" value="{{ old('westgeh_code', '') }}" required>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('jimara_dengderan') ? 'is-invalid' : '' }}" type="number" name="jimara_dengderan" id="jimara_dengderan" value="{{ old('jimara_dengderan', '') }}" step="1" required>
