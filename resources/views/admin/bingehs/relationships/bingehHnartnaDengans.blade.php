...
<div class="card border-primary">
    ...
    <div class="card-body text-info">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-bingehHnartnaDengans">
                <thead>
                    <tr>
                        <th width="10">
...
@endcan
  ...
  let table = $('.datatable-bingehHnartnaDengans:not(.ajaxTable)').DataTable({ buttons: dtButtons })
