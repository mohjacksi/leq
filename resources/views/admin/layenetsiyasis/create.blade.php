...
<div class="card border-primary">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.layenetsiyasi.title_singular') }}
    </div>

    <div class="card-body text-info">
        <form method="POST" action="{{ route("admin.layenetsiyasis.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('code_siyasi') ? 'is-invalid' : '' }}" type="text" name="code_siyasi" id="code_siyasi" value="{{ old('code_siyasi', '') }}" required>
            ...
            <div class="form-group col-md-6">
                ...
                <input class="form-control {{ $errors->has('jimara_kandida') ? 'is-invalid' : '' }}" type="number" name="jimara_kandida" id="jimara_kandida" value="{{ old('jimara_kandida', '') }}" step="1" required>
