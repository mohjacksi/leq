...
<div class="card border-primary">
    ...
    <div class="card-body text-info">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Layenetsiyasi">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.layenetsiyasis.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'name', name: 'name' },
{ data: 'code_siyasi', name: 'code_siyasi' },
{ data: 'ala', name: 'ala', sortable: false, searchable: false },
{ data: 'jimara_kandida', name: 'jimara_kandida' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Layenetsiyasi').DataTable(dtOverrideGlobals);
