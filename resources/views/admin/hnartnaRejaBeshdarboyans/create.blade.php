...
<div class="card border-primary">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.hnartnaRejaBeshdarboyan.title_singular') }}
    </div>

    <div class="card-body text-info">
        <form method="POST" action="{{ route("admin.hnartna-reja-beshdarboyans.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-row">
