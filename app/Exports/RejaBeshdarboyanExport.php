...
class RejaBeshdarboyanExport implements FromView, WithEvents, ShouldAutoSize
{
    public function __construct($data, $times, $lijnas)
    {
        $this->data = $data;
        $this->times = $times;
        $this->lijnas = $lijnas;
    ...
    public function view(): View
    {
        ...
        return view('admin.derencamenRejabeshdarboyans.export', [
            'data' => $this->data,
            'times' => $this->times,
            'lijnas' => $this->lijnas,
        ]);
